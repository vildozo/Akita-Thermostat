...
class AlarmsControllerTest < ActionController::TestCase
  ...
  test "should create alarm" do
    assert_difference('Alarm.count') do
      post :create, alarm: { temp_max: @alarm.temp_max, temp_min: @alarm.temp_min, thermostat_id: @alarm.thermostat_id, trigger_time: @alarm.trigger_time }
    end
  ...
  test "should update alarm" do
    patch :update, id: @alarm, alarm: { temp_max: @alarm.temp_max, temp_min: @alarm.temp_min, thermostat_id: @alarm.thermostat_id, trigger_time: @alarm.trigger_time }
    assert_redirected_to alarm_path(assigns(:alarm))
  end
